...
export default function Navbar({ onHomeClick }) {
  ...
  <header className="bg-white font-['Poppins'] shadow-[0_8px_28px_rgba(15,23,42,0.04)]">
    <nav className="grid grid-cols-[auto_auto] items-center justify-between px-4 py-2.5 sm:px-6 lg:grid-cols-[180px_1fr_180px] lg:px-9 lg:py-3">
      ...
      <div className="hidden items-center justify-center gap-x-7 text-[14px] font-semibold text-slate-950 lg:flex">
        {navLinks.map((link) => (
          <button
            ...
            className={`relative px-1 py-1.5 transition active:scale-95 ${
              activeLink === link
                ? 'text-sky-500'
      ...
      <div className="relative hidden items-center justify-end gap-3 lg:flex">
        ...
        >
          <input
            ...
            placeholder="Search"
            className="h-8 w-56 rounded-full border border-slate-200 bg-white px-4 text-xs font-medium text-slate-950 outline-none transition placeholder:text-slate-400 focus:border-sky-400"
            aria-label="Search"
          />
        </form>
        ...
        <button
          ...
          className="flex h-8 w-8 items-center justify-center rounded-full bg-slate-100 text-slate-950 transition hover:bg-sky-50 hover:text-sky-500 active:scale-95"
          aria-label="Search"
        >
        ...
        <button
          ...
          className="rounded-full bg-sky-400 px-5 py-2 text-xs font-extrabold text-white transition hover:bg-sky-500 active:scale-95"
        >
          Contact
        </button>
      </div>
      ...
      <button
        ...
        className="group flex h-10 w-10 flex-col items-center justify-center gap-1.5 rounded-md transition duration-200 hover:bg-sky-50 active:scale-90 active:bg-sky-100 lg:hidden"
